...
- `AZURE_RESOURCE_GROUP` (défaut `rg-identity-threat-simulator`)
- `AZURE_KEYVAULT_NAME` (défaut `its-keyvault-demo`)
- `AZURE_STORAGE_ACCOUNT_NAME` (défaut `itstoragedemonow`)
